...
if(isset($_POST['submit'])){
	...
	if($username=='pravega'){
		if(check_pravega_admin($password))
		{
			$_SESSION['user']='user';
			$_SESSION['database']='pravega';
			$_SESSION['admin']=1;
			header("Location: user.php");
		}
		elseif(check_pravega_user($password))
		{
			$_SESSION['user']='user';
			$_SESSION['database']='pravega';
			$_SESSION['admin']=0;
...
<html lang="en">
<head>
	<title>Who is free? | Pravega Racing Login</title>
				...
				<form action="#" method="post">
					<div class="row">
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" required id="username" name="username" value="pravega" class="form-control">
							</div>
						</div>
					</div>
					<div class="row">
